            ...
            <Card className="profile-update">
              <Card.Body>
                ...
                >
                  ...
                  <br />
                  <div className="bt">
                    <Button variant="info" type="submit" onClick={this.editUser}>Update Profile</Button>
                    <Button className="delete-button" variant="danger" onClick={() => this.onDeleteUser()}>Delete Profile</Button>
                  </div>
                </Form>
              </Card.Body>
            </Card>
